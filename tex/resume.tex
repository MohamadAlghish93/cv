...
% Mohamad Alghosh CV - Generated from YAML data
% Source: https://github.com/MohamadAlghish93/cv
...
%\definecolor{awesome}{HTML}{3A63CA}
%% Colors for text
...
\begingroup
  \hypersetup{
    ...
    citecolor=white,
    pdfborder={0 0 0},
    pdftitle   = {CV: Mohamad Alghosh},
    pdfauthor  = {Mohamad Alghosh},
    pdfsubject = {Curriculum Vitae},
    pdfkeywords= {principal engineer, software engineering, CV, resume, Mohamad Alghosh},
    pdfcreator = {LaTeX with XeTeX},
    pdfproducer = {XeTeX},
    pdflang = {en-GB},
    pdfcreationdate = {D:20120901162042+01'00'},
    pdfmoddate = {D:20250827001351+00'00'},
...
\roundedheaderbox{headerbg}{
  \color{white} %
  \begin{center} %
    \headerfirstnamestyle{ Mohamad } %
    \headerlastnamestyle{  Alghosh }\\[2mm] %
    \faEnvelope~\href{mailto:MohamadAlghish1993@gmail.com}{MohamadAlghish1993@gmail.com} %
    \quad|\quad %
    \faMapMarker~Dubai, UAE %
    \quad|\quad %
    \faLink~\href{ https://github.com/MohamadAlghish93 }{ https://github.com/MohamadAlghish93 } %
  \end{center} %
}
\endgroup
\vspace{0mm} %
...
\begin{center}
    ...
    \href{https://www.alghosh.website}{ Mohamad Alghosh } {\the\year}
\end{center}
\ 
\end{document}
